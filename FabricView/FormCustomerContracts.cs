    ...
    public partial class FormCustomerContracts : Form
    {
        ...
        private void buttonMake_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var dataSource = Task.Run(() => APIClient.PostRequestData<ReportBindingModel, List<CustomerContractsModel>>("api/Report/GetCustomerContracts",
        ...
        private void buttonToPdf_Click(object sender, EventArgs e)
        {
            ...
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                ...
                Task task = Task.Run(() => APIClient.PostRequestData("api/Report/SaveCustomerContracts", new ReportBindingModel
                {
                    FileName = fileName,
                    DateFrom = dateTimePickerFrom.Value,
                    DateTo = dateTimePickerTo.Value
