<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormPutOnStorage.aspx.cs" Inherits="FabricWebView.FormPutOnStorage" %>
...
<body>
    ...
    <div>
        ...
        <br />
        Компонент&nbsp;&nbsp;
        <asp:DropDownList ID="DropDownListPart" runat="server" Height="17px" Width="194px">
        </asp:DropDownList>
        <br />
        <br />
        Количество&nbsp;
